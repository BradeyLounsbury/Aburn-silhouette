...
#include <vector>
#include <memory>
#include "GLViewSilhouette.h" //GLView subclass instantiated to drive this simulation
...
int main( int argc, char* argv[] )
{
   ...
   do
   {
      std::unique_ptr< Aftr::GLViewSilhouette > glView( Aftr::GLViewSilhouette::New( args ) );
