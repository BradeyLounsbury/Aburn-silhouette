...
GLViewSilhouette* GLViewSilhouette::New( const std::vector< std::string >& args )
{
   GLViewSilhouette* glv = new GLViewSilhouette( args );
...
GLViewSilhouette::GLViewSilhouette( const std::vector< std::string >& args ) : GLView( args )
{
   //Initialize any member variables that need to be used inside of LoadMap() here.
   //Note: At this point, the Managers are not yet initialized. The Engine initialization
   //occurs immediately after this method returns (see GLViewSilhouette::New() for
   ...
   //GLViewSilhouette::onCreate() is invoked after this module's LoadMap() is completed.
}


void GLViewSilhouette::onCreate()
{
   //GLViewSilhouette::onCreate() is invoked after this module's LoadMap() is completed.
...
GLViewSilhouette::~GLViewSilhouette()
{
...
void GLViewSilhouette::onResizeWindow( GLsizei width, GLsizei height )
{
   GLView::onResizeWindow( width, height ); //call parent's resize method.
}


void GLViewSilhouette::onMouseDown( const SDL_MouseButtonEvent& e )
{
   GLView::onMouseDown( e );
}


void GLViewSilhouette::onMouseUp( const SDL_MouseButtonEvent& e )
{
   GLView::onMouseUp( e );
}


void GLViewSilhouette::onMouseMove( const SDL_MouseMotionEvent& e )
{
   GLView::onMouseMove( e );
}


void GLViewSilhouette::onKeyDown( const SDL_KeyboardEvent& key )
{
...
void Aftr::GLViewSilhouette::loadMap()
{
...
void GLViewSilhouette::createSilhouetteWayPoints()
{
